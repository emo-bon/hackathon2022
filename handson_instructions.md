...
## Data Provenance
    ...
    Throughtout this exercise, note down what provenance information (metadata) you would record so that it could be published with the results. At the end of the session we will be a discussion of what should be included in the provenance metadata.
